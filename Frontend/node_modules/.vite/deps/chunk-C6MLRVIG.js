...
function getChildMapping(children2, mapFn) {
  ...
  if (children2) import_react12.Children.map(children2, function(c) {
    return c;
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react14.default.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-C6MLRVIG.js.map
